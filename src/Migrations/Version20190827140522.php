 ...
 */
final class Version20190827140522 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag CHANGE name name VARCHAR(55) NOT NULL, CHANGE slug slug VARCHAR(55) NOT NULL');
    }
